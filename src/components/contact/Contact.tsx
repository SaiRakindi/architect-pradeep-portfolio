...
export default function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative py-32 md:py-48 bg-graphite overflow-hidden">
      <div className="absolute inset-0 blueprint-bg opacity-15 pointer-events-none" />

      {/* Large bg text */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 font-display text-[20vw] font-light text-white/2 select-none pointer-events-none leading-none">
        HELLO
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 relative z-10">
        ...
        <div className="contact-title opacity-0 mb-20">
          <div className="flex items-center gap-4 mb-6">
            <span className="font-mono text-xs text-steel tracking-ultra-wide uppercase">06 — Contact</span>
            <div className="flex-1 h-px bg-steel/20" />
          </div>
          <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-light text-bone">
            Let&apos;s Build<br />
            <span className="italic text-steel">Something</span><br />
            Remarkable
          </h2>
        </div>
        ...
        <div className="contact-grid grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="contact-left opacity-0 space-y-12">
            <p className="font-sans text-base text-concrete leading-relaxed max-w-md">
              ...
              I&apos;m always open to a conversation about great architecture.
            </p>

            {/* Contact details */}
            <div className="space-y-6">
              {[
                { label: "Email", value: "aria@solanoarchitects.com", href: "mailto:aria@solanoarchitects.com" },
                { label: "Phone", value: "+1 (604) 555-0192", href: "tel:+16045550192" },
                { label: "Studio", value: "Vancouver, BC, Canada", href: "#" },
              ].map((item) => (
                <div key={item.label} className="group">
                  <p className="font-mono text-xs text-steel/60 tracking-wider uppercase mb-1">{item.label}</p>
                  <a
                    href={item.href}
            ...
            <div className="inline-flex items-center gap-3 border border-white/10 px-5 py-3">
              ...
              <span className="font-mono text-xs text-concrete tracking-wider">Available for 2025 Projects</span>
            </div>
            ...
            <blockquote className="border-l-2 border-steel/40 pl-5">
              ...
              <cite className="font-mono text-xs text-concrete/40 mt-2 block">— Walter Gropius</cite>
            </blockquote>
          </div>
          ...
          <div className="contact-right opacity-0">
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-16">
                ...
                <h3 className="font-display text-3xl text-bone mb-3">Message Received</h3>
                <p className="font-sans text-concrete text-sm leading-relaxed max-w-xs">
                  Thank you for reaching out. I&apos;ll review your project and respond within 48 hours.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    >
                      <option value="" className="bg-graphite">Select type</option>
                      <option value="residential" className="bg-graphite">Residential</option>
                      <option value="commercial" className="bg-graphite">Commercial</option>
                      <option value="urban" className="bg-graphite">Urban / Masterplan</option>
                      <option value="interior" className="bg-graphite">Interior Design</option>
                      <option value="consultation" className="bg-graphite">Consultation</option>
                    </select>
                  </div>
                  <div>
                    <label className="font-mono text-xs text-steel/60 tracking-wider uppercase block mb-2">
                    ...
                    >
                      <option value="" className="bg-graphite">Select range</option>
                      <option value="under50k" className="bg-graphite">Under $50K</option>
                      <option value="50-150k" className="bg-graphite">$50K – $150K</option>
                      <option value="150-500k" className="bg-graphite">$150K – $500K</option>
                      <option value="500k+" className="bg-graphite">$500K+</option>
                    </select>
                  </div>
                </div>
