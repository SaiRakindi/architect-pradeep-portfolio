    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="flex items-center gap-4 mb-20">
          <span className="font-mono text-xs text-steel tracking-ultra-wide uppercase">01 — About</span>
          <div ref={lineRef} className="flex-1 h-px bg-steel/30 origin-left" style={{ transform: "scaleX(0)" }} />
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          {/* Portrait */}
          <div ref={imageRef} className="relative" style={{ clipPath: "inset(100% 0 0 0)", opacity: 0 }}>
            {/* Architectural frame */}
            <div className="relative aspect-[3/4] overflow-hidden bg-graphite">
              ...
              <div className="absolute inset-0 flex items-end justify-center overflow-hidden">
                ...
                <svg viewBox="0 0 400 533" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                  ...
                  {/* Moon */}
                  <circle cx="320" cy="80" r="25" fill="none" stroke="#4A6FA5" strokeWidth="1" opacity="0.6" />
                  <circle cx="320" cy="80" r="20" fill="#1a2a3a" opacity="0.8" />
                  ...
                  <g opacity="0.9">
                    ...
                    {/* Hair */}
                    <path d="M172 262 Q200 238 228 262 Q220 245 200 242 Q180 245 172 262Z" fill="#0a0f1a" />
                    {/* Shoulder outline */}
                    <path d="M155 355 Q180 320 200 315 Q220 320 245 355 Q240 360 200 362 Q160 360 155 355Z" fill="#0a0f18" />
                    {/* Face detail */}
                    <path d="M188 278 Q200 275 212 278" stroke="#4A6FA5" strokeWidth="0.5" fill="none" opacity="0.5" />
                  </g>
                  {/* Blueprint city behind */}
                  <g opacity="0.5" stroke="#4A6FA5" strokeWidth="0.5" fill="none">
                    {/* Buildings */}
                  ...
                  <ellipse cx="200" cy="410" rx="120" ry="20" fill="#4A6FA5" opacity="0.08" />
                  {/* Name plate */}
                  <text x="200" y="490" textAnchor="middle" fontFamily="Georgia" fontSize="11" fill="#4A6FA5" opacity="0.6" letterSpacing="4">ARIA SOLANO</text>
                  <text x="200" y="510" textAnchor="middle" fontFamily="monospace" fontSize="8" fill="#8C8C8C" opacity="0.5" letterSpacing="2">ARCHITECT</text>
                </svg>
              </div>
              {/* Overlay */}
            ...
            <div className="absolute top-6 -right-4 md:-right-8 bg-obsidian border border-steel/30 px-4 py-3 text-center">
              ...
              <p className="font-mono text-xs text-concrete tracking-wider mt-1">Years Study</p>
            </div>
          </div>
          ...
          <div ref={textRef} className="space-y-8">
            <h2 className="animate-text font-display text-4xl md:text-5xl lg:text-6xl font-light text-bone leading-tight">
              Where Structure Meets <span className="italic text-steel">Soul</span>
            </h2>

            <p className="animate-text font-sans text-base text-concrete leading-relaxed">
              I am Aria Solano, a graduate architect from the University of British Columbia School of Architecture.
              My practice exists at the intersection of structural rigor and human experience — designing spaces
              that feel as precise as they do profound.
            </p>

            <p className="animate-text font-sans text-base text-concrete leading-relaxed">
              Trained in both computational design and traditional draftsmanship, I approach each project as an
              act of translation: turning a client&apos;s vision into built form that resonates beyond function.
            </p>
            ...
            <div className="animate-text grid grid-cols-2 gap-6 pt-4">
              {[
                ...
                <div key={item.label} className="border-l border-steel/30 pl-4">
                  <p className="font-mono text-xs text-steel tracking-wider uppercase mb-1">{item.label}</p>
